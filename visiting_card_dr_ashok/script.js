...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Dynamic e-Card Page URL (points to Dr. Ashok's live visiting card location)
    const cardUrl = "https://activerehabtranscare.in/visiting_card_dr_ashok/";
    ...
    if (btnSaveContact) {
        btnSaveContact.addEventListener("click", () => {
            ...
            const fileName = "Dr_Ashok_P_Kota_ActiveRehab.vcf";
    ...
    if (btnShareCard) {
        btnShareCard.addEventListener("click", async () => {
            const shareData = {
                title: "Dr Ashok P Kota - ActiveRehab TransCare",
                text: "Lead Physiotherapist & Clinical Director, ActiveRehab TransCare & Rehabilitation. Save contact or connect directly:",
                url: cardUrl
            };
            ...
            if (navigator.share) {
                ...
                try {
                    ...
                    showToast("Link: activerehabtranscare.in/visiting_card_dr_ashok/");
                }
            }
        });
    }
